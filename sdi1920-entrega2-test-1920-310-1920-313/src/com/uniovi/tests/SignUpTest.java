...
public class SignUpTest {
	...
	public void PR01() {
		...
		PO_RegisterView.fillForm(driver, name, UUID.randomUUID().toString(),
				UUID.randomUUID().toString() + "@uniovi.com", "123456", "123456");
	...
	public void PR02() {
		PO_HomeView.clickOption(driver, "registrarse", "class", "btn btn-primary");
		PO_RegisterView.fillForm(driver, UUID.randomUUID().toString(), UUID.randomUUID().toString(), "", "123456",
				"123456");
		PO_HomeView.checkElement(driver, "text", "El campo email no puede estar vacio.");
		PO_RegisterView.fillForm(driver, "", UUID.randomUUID().toString(), UUID.randomUUID().toString() + "@uniovi.com",
				"123456", "123456");
	...
	public void PR03() {
		PO_HomeView.clickOption(driver, "registrarse", "class", "btn btn-primary");
		PO_RegisterView.fillForm(driver, UUID.randomUUID().toString(), UUID.randomUUID().toString(),
				UUID.randomUUID().toString() + "@uniovi.com", "123456", "1234567");
	...
	public void PR04() {
		PO_HomeView.clickOption(driver, "registrarse", "class", "btn btn-primary");
		PO_RegisterView.fillForm(driver, "Mori", "Jin", "Monarch@gmail.com", "123456", "1234567");
